...
static ds18b20_err_t ds18b20_ow_initialize(ds18b20_t const *ds18b20) {
  return ds18b20->interface.ow_initialize
             ? ds18b20->interface.ow_initialize(ds18b20->interface.ow_user)
             : DS18B20_ERR_NULL;
}

static ds18b20_err_t ds18b20_ow_deinitialize(ds18b20_t const *ds18b20) {
  return ds18b20->interface.ow_deinitialize
             ? ds18b20->interface.ow_deinitialize(ds18b20->interface.ow_user)
             : DS18B20_ERR_NULL;
}

static ds18b20_err_t ds18b20_ow_reset(ds18b20_t const *ds18b20) {
  return ds18b20->interface.ow_reset
             ? ds18b20->interface.ow_reset(ds18b20->interface.ow_user)
             : DS18B20_ERR_NULL;
}

static ds18b20_err_t ds18b20_ow_transmit(ds18b20_t const *ds18b20,
                                         uint8_t const *data,
                                         size_t data_size) {
  return ds18b20->interface.ow_transmit
             ? ds18b20->interface.ow_transmit(ds18b20->interface.ow_user, data,
                                              data_size)
             : DS18B20_ERR_NULL;
}

static ds18b20_err_t ds18b20_ow_receive(ds18b20_t const *ds18b20, uint8_t *data,
                                        size_t data_size) {
  return ds18b20->interface.ow_receive
             ? ds18b20->interface.ow_receive(ds18b20->interface.ow_user, data,
                                             data_size)
             : DS18B20_ERR_NULL;
}
...
ds18b20_err_t ds18b20_initialize(ds18b20_t *ds18b20,
  ...
  return ds18b20_ow_initialize(ds18b20);
}

ds18b20_err_t ds18b20_deinitialize(ds18b20_t *ds18b20) {
  assert(ds18b20);

  ds18b20_err_t err = ds18b20_ow_deinitialize(ds18b20);
